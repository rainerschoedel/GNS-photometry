pro merge_sublists_noshift, field, Band, chip_nr
...
plotdir = 'plots/'
indir = '/home/data/GNS/2015/'+ Band + '/' + field
outdir = indir
photdir = indir + '/photo/' + chip + '/lists/'
imdir = indir + '/cubeims/' + chip + '/'
...
dup_tolerance = 1.5 ; Tolerance in search for potential duplocates
...
; offsets are needed in merge_subims.pro
...
SAVE, x_offsets, FILENAME=photdir + 'x_offsets_' + chip + '_' + band + '.SAV'
SAVE, y_offsets, FILENAME=photdir + 'y_offsets_' + chip + '_' + band + '.SAV'
...
openw, out, photdir + 'astrophot_noshift.txt', /get_lun
